 ...
 *
 */
public class TableHeaderConsumerFactoryAdapter extends TableSectionConsumerFactoryAdapter<org.nasdanika.models.bootstrap.TableHeader, org.nasdanika.html.bootstrap.Table.TableHeader> {

	public TableHeaderConsumerFactoryAdapter(org.nasdanika.models.bootstrap.TableHeader tableHeader, AdapterFactory adapterFactory) {
	...
	protected Function<HTMLElement<?>, HTMLElement<?>> createConfigureFunction(Context context) {
		...
		Consumer<org.nasdanika.html.bootstrap.Table.TableHeader> configurator = new Consumer<org.nasdanika.html.bootstrap.Table.TableHeader>() {
			...
			public void execute(org.nasdanika.html.bootstrap.Table.TableHeader header, ProgressMonitor progressMonitor) {
				org.nasdanika.models.bootstrap.TableHeader semanticElement = getTarget();
