...
public class BootstrapProducerFactoryCapabilityFactory implements CapabilityFactory<ProducerFactoryRequirement, Object> {
	...
	public CompletionStage<Iterable<CapabilityProvider<Object>>> create(
		...
		BootstraphProducerFactory factory = new BootstraphProducerFactory(requirement.context());
