 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.bootstrap.impl.AppearanceImpl#getBackground <em>Background</em>}</li>
 *   <li>{@link org.nasdanika.models.bootstrap.impl.AppearanceImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.nasdanika.models.bootstrap.impl.AppearanceImpl#getBorder <em>Border</em>}</li>
 *   <li>{@link org.nasdanika.models.bootstrap.impl.AppearanceImpl#getMargin <em>Margin</em>}</li>
 *   <li>{@link org.nasdanika.models.bootstrap.impl.AppearanceImpl#getPadding <em>Padding</em>}</li>
 *   <li>{@link org.nasdanika.models.bootstrap.impl.AppearanceImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.nasdanika.models.bootstrap.impl.AppearanceImpl#getFloat <em>Float</em>}</li>
 *   <li>{@link org.nasdanika.models.bootstrap.impl.AppearanceImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AppearanceImpl extends MinimalEObjectImpl.Container implements Appearance {
	...
	@SuppressWarnings("unchecked")
	@Override
	public EList<org.nasdanika.models.bootstrap.Float> getFloat() {
		return (EList<org.nasdanika.models.bootstrap.Float>)eDynamicGet(BootstrapPackage.APPEARANCE__FLOAT, BootstrapPackage.Literals.APPEARANCE__FLOAT, true, true);
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case BootstrapPackage.APPEARANCE__FLOAT:
				getFloat().clear();
				getFloat().addAll((Collection<? extends org.nasdanika.models.bootstrap.Float>)newValue);
				return;
			case BootstrapPackage.APPEARANCE__CHILDREN:
